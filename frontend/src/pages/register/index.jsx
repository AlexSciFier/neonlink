...
export default function RegisterPage() {
  ...
  return (
    <div className="flex w-screen h-screen justify-center items-center p-4 ">
      <div className="flex flex-col gap-3 items-center sm:w-1/4 w-4/5 px-6 py-4 rounded-xl bg-white dark:bg-black/30 dark:backdrop-blur-xl dark:border-0">
        <Logo />
        ...
        >
          ...
          ></input>
          <button
            className="bg-cyan-600 hover:bg-cyan-400 disabled:bg-gray-600 rounded px-4 py-2 w-full"
            type="submit"
